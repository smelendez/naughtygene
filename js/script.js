                ...
                hidenode: true
                                    ...
                                    _children : [{
                                        ...
                                        children: [{
                                            ...
                                            height: 300,
                                            stopothers: true,
                                            url: 'videos/NEW_neurons_lab_with_dialogue_and_music_no fade.mp4',
                                            id: 'endVideo',
                                            xoffset: 60,
                                            position: 'center',
                                            hidenode: true
            ...
            var nodeEnter = node.enter().append("svg:g")
                ...
                .each(function(d, i) {
                    ...
                    case 'video':
                        ...
                        if (_.has(d, 'cue'))
                        {
                            var frag = '<div id="' + d.id + '" style="cursor:pointer"> <video width="' + d.width + '" height="' + d.height + '"  id="video-' + d.id + '" autoplay ';
                            if (_.has(d, 'loop'))
                            {
                                frag += 'loop';
                            }
